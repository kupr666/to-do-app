...
import (
	...
	statistics_postgres_repository "github.com/kupr666/to-do-app/internal/features/statistics/repository/postgres"
	statistics_service "github.com/kupr666/to-do-app/internal/features/statistics/service"
	statistics_transport_http "github.com/kupr666/to-do-app/internal/features/statistics/transport/http"
...
func main() {
	...
	statisticsService := statistics_service.NewStatService(statisticsRepository)
	statisticsTransportHTTP := statistics_transport_http.NewStatHTTPHandler(statisticsService)
